class RFunction {
    ...
    decrypt(encrypted) {
        ...
        // step 2: o5 with Q5
        bytes = this.applyTransformations(bytes, this.Q5(), [
            "i",
            "k",
            "b",
            "i",
        ...
        // step 4: h5 with p
        bytes = this.applyTransformations(bytes, this.p(), [
            "_",
            "b",
            "_",
            "Y",
        ...
        // step 6: v5 with k5
        bytes = this.applyTransformations(bytes, this.k5(), [
            "Y",
            "W",
            "f",
            "O",
        ...
        // step 8: Z5 with p5
        bytes = this.applyTransformations(bytes, this.p5(), [
            "Y",
            "A",
            "f",
            "i",
        ...
        // step 10: d with r5
        bytes = this.applyTransformations(bytes, this.r5(), [
            "f",
            "k",
            "i",
            "w",
